...
m
  .
def
("setJoystickName", &::HALSIM_SetJoystickName,
      py::arg("stick"), py::arg("name"), py::arg("size"), release_gil()
  )
...
m
  .
def
("setGameSpecificMessage", &::HALSIM_SetGameSpecificMessage,
      py::arg("message"), py::arg("size"), release_gil()
  )
...
m
  .
def
("setEventName", &::HALSIM_SetEventName,
      py::arg("name"), py::arg("size"), release_gil()
  )
