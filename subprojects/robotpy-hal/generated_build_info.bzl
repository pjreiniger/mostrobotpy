...
def hal_simulation_extension(entry_point, deps, header_to_dat_deps, extension_name = None, extra_hdrs = [], extra_srcs = [], includes = []):
    HAL_SIMULATION_HEADER_GEN = [
        ...
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/simulation/AddressableLEDData.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
        ...
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/simulation/CTREPCMData.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/simulation/DIOData.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/simulation/DigitalPWMData.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/simulation/DriverStationData.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/simulation/DutyCycleData.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/simulation/EncoderData.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/simulation/MockHooks.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/simulation/NotifierData.h",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/simulation/PWMData.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/simulation/PowerDistributionData.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/simulation/REVPHData.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
        ...
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/simulation/Reset.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
        ...
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/simulation/SimDeviceData.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
    ]
...
def wpihal_extension(entry_point, deps, header_to_dat_deps, extension_name = None, extra_hdrs = [], extra_srcs = [], includes = []):
    WPIHAL_HEADER_GEN = [
        ...
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/AddressableLED.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/AddressableLEDTypes.h",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/CAN.h",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/CANAPI.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
        ...
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/CTREPCM.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/Constants.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/Counter.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/DIO.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/DriverStation.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/DriverStationTypes.h",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/DutyCycle.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/Encoder.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/Extensions.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
        ...
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/HALBase.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/I2C.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
        ...
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/Main.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/Notifier.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/PWM.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/Ports.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/Power.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/PowerDistribution.h",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/REVPH.h",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/SerialPort.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/SimDevice.h",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/Threads.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal"),
            header_file = resolve_include_root("//subprojects/robotpy-native-wpihal", "wpihal") + "/hal/handles/HandlesInternal.h",
            tmpl_class_names = [],
            trampolines = [],
        ),
    ]
