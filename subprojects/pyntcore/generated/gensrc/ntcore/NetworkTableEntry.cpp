...
struct rpybuild_NetworkTableEntry_initializer {
  ...
  py::enum_<nt::NetworkTableEntry::Flags> cls_NetworkTableEntry_enum1;
  ...
  rpybuild_NetworkTableEntry_initializer(py::module &m) :
    ...
    cls_NetworkTableEntry_enum1
  (cls_NetworkTableEntry, "Flags"
  ,
    "Flag values (as returned by GetFlags()).\n"
"\n"
":deprecated: Use IsPersistent() instead.", py::arithmetic()),
    ...
    m(m)
  {
    ...
    .value("kPersistent", nt::NetworkTableEntry::Flags::kPersistent)
  ;
...
void finish() {
  ...
  using Flags [[maybe_unused]] = typename nt::NetworkTableEntry::Flags;
...
":returns: the entry's type")
  ...
  .
def
("getFlags", &nt::NetworkTableEntry::GetFlags, release_gil(), py::doc(
    "Returns the flags.\n"
"\n"
...
":returns: False if the entry exists with a different type")
  ...
  .
def
("setFlags", &nt::NetworkTableEntry::SetFlags,
      py::arg("flags"), release_gil(), py::doc(
    "Sets flags.\n"
"\n"
...
":param flags: the flags to set (bitmask)")
  ...
  .
def
("clearFlags", &nt::NetworkTableEntry::ClearFlags,
      py::arg("flags"), release_gil(), py::doc(
    "Clears flags.\n"
"\n"
":deprecated: Use SetPersistent() or topic properties instead\n"
...
("unpublish", &nt::NetworkTableEntry::Unpublish, release_gil(), py::doc(
  ...
  .
def
("delete", &nt::NetworkTableEntry::Delete, release_gil(), py::doc(
    "Deletes the entry.\n"
"\n"
