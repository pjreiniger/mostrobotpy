...
def define_pybind_library(name, version, extra_entry_points = {}):
    ...
    robotpy_library(
        ...
        data = get_generated_data_files() + ["robotpy_apriltag.extra_pkg_files", ":pyi_files"],
        imports = ["."],
        robotpy_wheel_deps = [
            "//subprojects/robotpy-native-apriltag:import",
            "//subprojects/robotpy-native-wpimath:import",
        ...
        package_requires = ["robotpy-native-apriltag==2027.0.0a1.dev0", "robotpy-wpiutil==2027.0.0a1.dev0", "robotpy-wpimath==2027.0.0a1.dev0"],
    )
