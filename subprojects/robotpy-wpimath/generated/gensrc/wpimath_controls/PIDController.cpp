...
":returns: The period of the controller.")
  ...
  .
def
("getErrorTolerance", &frc::PIDController::GetErrorTolerance, release_gil(), py::doc(
...
":returns: The error tolerance of the controller.")
  ...
  .
def
("getErrorDerivativeTolerance", &frc::PIDController::GetErrorDerivativeTolerance, release_gil(), py::doc(
...
":returns: The velocity tolerance of the controller.")
  ...
  .
def
("getAccumulatedError", &frc::PIDController::GetAccumulatedError, release_gil(), py::doc(
...
("setTolerance", &frc::PIDController::SetTolerance,
      py::arg("errorTolerance"), py::arg("errorDerivativeTolerance") = std::numeric_limits<double>::infinity (), release_gil(), py::doc(
...
":param errorDerivativeTolerance: error derivative which is tolerable.")
  ...
  .
def
("getError", &frc::PIDController::GetError, release_gil(), py::doc(
  ...
  .
def
("getErrorDerivative", &frc::PIDController::GetErrorDerivative, release_gil(), py::doc(
