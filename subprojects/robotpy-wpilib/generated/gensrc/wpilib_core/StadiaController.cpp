...
struct rpybuild_StadiaController_initializer {
  ...
  py::class_<typename frc::StadiaController, StadiaController_Trampoline, frc::GenericHID, wpi::Sendable> cls_StadiaController;
...
"          digital signal attached to the given loop.")
  ...
  .
def
("getLeftBumperButton", &frc::StadiaController::GetLeftBumperButton, release_gil(), py::doc(
...
":returns: The state of the button.")
  ...
  .
def
("getLeftBumperButtonPressed", &frc::StadiaController::GetLeftBumperButtonPressed, release_gil(), py::doc(
...
":returns: Whether the button was pressed since the last check.")
  ...
  .
def
("getLeftBumperButtonReleased", &frc::StadiaController::GetLeftBumperButtonReleased, release_gil(), py::doc(
...
"          digital signal attached to the given loop.")
  ...
  .
def
("getRightBumperButton", &frc::StadiaController::GetRightBumperButton, release_gil(), py::doc(
...
":returns: The state of the button.")
  ...
  .
def
("getRightBumperButtonPressed", &frc::StadiaController::GetRightBumperButtonPressed, release_gil(), py::doc(
...
":returns: Whether the button was pressed since the last check.")
  ...
  .
def
("getRightBumperButtonReleased", &frc::StadiaController::GetRightBumperButtonReleased, release_gil(), py::doc(
...
":returns: Whether the button was released since the last check.")
  ...
  .
def
("initSendable", &frc::StadiaController::InitSendable,
