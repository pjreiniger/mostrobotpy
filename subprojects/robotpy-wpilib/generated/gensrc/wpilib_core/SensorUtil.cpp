...
":returns: Analog channel is valid")
  ...
  .
def_static
("getNumDigitalChannels", &frc::SensorUtil::GetNumDigitalChannels, release_gil()
  )
  ...
  .
def_static
("getNumAnalogInputs", &frc::SensorUtil::GetNumAnalogInputs, release_gil()
  )
  ...
  .
def_static
("getNumAnalogOuputs", &frc::SensorUtil::GetNumAnalogOuputs, release_gil()
  )
  ...
  .
def_static
("getNumPwmChannels", &frc::SensorUtil::GetNumPwmChannels, release_gil()
  )
  ...
  .
def_static
("getNumRelayChannels", &frc::SensorUtil::GetNumRelayChannels, release_gil()
  )
