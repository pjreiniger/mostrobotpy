...
static void initWrapper(py::module &m) {
    ...
    begin_init_SendableChooserSim(m);
    begin_init_SharpIRSim(m);
    ...
    begin_init_StadiaControllerSim(m);
    ...
    finish_init_SendableChooserSim();
    finish_init_SharpIRSim();
    ...
    finish_init_StadiaControllerSim();
