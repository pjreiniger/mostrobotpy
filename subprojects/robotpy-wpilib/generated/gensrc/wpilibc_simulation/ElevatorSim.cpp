...
struct rpybuild_ElevatorSim_initializer {
  ...
  py::class_<typename frc::sim::ElevatorSim, ElevatorSim_Trampoline, frc::sim::LinearSystemSim<2, 1, 1>> cls_ElevatorSim;
...
void finish() {
  ...
  .def(py::init<const LinearSystem<2, 1, 1>&, const DCMotor&, units::meter_t, units::meter_t, bool, units::meter_t, const std::array<double, 1>&>(),
      py::arg("plant"), py::arg("gearbox"), py::arg("minHeight"), py::arg("maxHeight"), py::arg("simulateGravity"), py::arg("startingHeight"), py::arg("measurementStdDevs") = std::array<double, 1>{0.0}, release_gil()
    , py::keep_alive<1, 2>()
    , py::keep_alive<1, 3>()
...
":param measurementStdDevs: The standard deviation of the measurements.")
  ...
  .def(py::init<const DCMotor&, double, units::kilogram_t, units::meter_t, units::meter_t, units::meter_t, bool, units::meter_t, const std::array<double, 1>&>(),
      py::arg("gearbox"), py::arg("gearing"), py::arg("carriageMass"), py::arg("drumRadius"), py::arg("minHeight"), py::arg("maxHeight"), py::arg("simulateGravity"), py::arg("startingHeight"), py::arg("measurementStdDevs") = std::array<double, 1>{0.0}, release_gil()
    , py::keep_alive<1, 2>()
