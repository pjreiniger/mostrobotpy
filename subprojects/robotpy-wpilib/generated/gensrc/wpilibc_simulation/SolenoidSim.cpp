...
#define RPYGEN_ENABLE_frc__sim__SolenoidSim_PROTECTED_CONSTRUCTORS
#include <rpygen/frc__sim__SolenoidSim.hpp>
...
struct rpybuild_SolenoidSim_initializer {
  ...
  using SolenoidSim_Trampoline = rpygen::PyTrampoline_frc__sim__SolenoidSim<typename frc::sim::SolenoidSim, typename rpygen::PyTrampolineCfg_frc__sim__SolenoidSim<>>;
    static_assert(std::is_abstract<SolenoidSim_Trampoline>::value == false, "frc::sim::SolenoidSim " RPYBUILD_BAD_TRAMPOLINE);
  py::class_<typename frc::sim::SolenoidSim, SolenoidSim_Trampoline> cls_SolenoidSim;
