...
struct rpybuild_SingleJointedArmSim_initializer {
  ...
  py::class_<typename frc::sim::SingleJointedArmSim, SingleJointedArmSim_Trampoline, frc::sim::LinearSystemSim<2, 1, 1>> cls_SingleJointedArmSim;
...
void finish() {
  ...
  .def(py::init<const LinearSystem<2, 1, 1>&, const DCMotor&, double, units::meter_t, units::radian_t, units::radian_t, bool, units::radian_t, const std::array<double, 1>&>(),
      py::arg("system"), py::arg("gearbox"), py::arg("gearing"), py::arg("armLength"), py::arg("minAngle"), py::arg("maxAngle"), py::arg("simulateGravity"), py::arg("startingAngle"), py::arg("measurementStdDevs") = std::array<double, 1>{0.0}, release_gil()
    , py::keep_alive<1, 2>()
    , py::keep_alive<1, 3>()
...
":param measurementStdDevs: The standard deviations of the measurements.")
  ...
  .def(py::init<const DCMotor&, double, units::kilogram_square_meter_t, units::meter_t, units::radian_t, units::radian_t, bool, units::radian_t, const std::array<double, 1>&>(),
      py::arg("gearbox"), py::arg("gearing"), py::arg("moi"), py::arg("armLength"), py::arg("minAngle"), py::arg("maxAngle"), py::arg("simulateGravity"), py::arg("startingAngle"), py::arg("measurementStdDevs") = std::array<double, 1>{0.0}, release_gil()
    , py::keep_alive<1, 2>()
    , py::keep_alive<1, 10>(), py::doc(
    "Creates a simulated arm mechanism.\n"
"\n"
