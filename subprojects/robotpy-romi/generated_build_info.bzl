...
def romi_extension(entry_point, deps, header_to_dat_deps = [], extension_name = None, extra_hdrs = [], extra_srcs = [], includes = [], extra_pyi_deps = []):
    ...
    whl_filegroup(
        name = "romi.wheel.trampoline_files",
        pattern = "romi/trampolines",
        whl = ":romi-wheel",
    ...
    cc_library(
        name = "romi.wheel.trampoline_hdrs",
        hdrs = [":romi.wheel.trampoline_files"],
        includes = ["romi.wheel.trampoline_files/romi"],
        tags = ["manual"],
    )
    ...
    make_pyi(
        ...
        python_deps = [
            ...
            local_pybind_library("//subprojects/robotpy-native-romi", "robotpy-native-romi"),
